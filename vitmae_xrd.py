...
def train_model(num_epochs=100):
    ...
    for epoch in range(num_epochs):
        for idx, data in enumerate(square_xrd_dataloader):
            ...
            if idx % 2500 == 0:
                torch.save(model.state_dict(), f'/pscratch/sd/h/hasitha/xrd/vitmae_xrd/vitmae_xrd_epoch_{epoch}batch_{idx}.pth')
            if idx % 5 == 0:
...
torch.save(model.state_dict(), '/global/homes/h/hasitha/latent_xrd/vitmae_xrd.pth')
print('Model saved')